...
remera_l = Prenda (101,"remera talle l", "remera", 4500)
...
local_retiro.registrar_producto(remera_l)
...
remera_m.agregar_categoria("fultbol")
remera_l.agregar_categoria("basquet")
